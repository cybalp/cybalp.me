...
// ❯ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ❯ @status OK!
// ❯ @path ./src/components/navbar/displaySettings.svelte
// ❯ @desc Display settings panel with theme color picker.
// ❯ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// ❯ EVENT HANDLERS
// ❯ @doc Resets hue to default value.
function resetHue() {
	hue = getDefaultHue();
}
...
// ❯ @doc Opens display settings panel.
function openPanel() {
	isOpen = true;
}

// ❯ @doc Closes display settings panel.
function closePanel() {
	isOpen = false;
}
...
<div class="relative z-50" role="menu" onmouseleave={closePanel}>
