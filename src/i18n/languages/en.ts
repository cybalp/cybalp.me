...
export const en: Translation = {
	...
	// Navigations
	[Key.main]: "Main",
	[Key.mainSubtitle]: "CybAlp - A Cybersecurity | A Linux Enthusiast | A Coder",
	[Key.vault]: "Vault",
	[Key.vaultSubtitle]: "Those who have the password",
	[Key.dump]: "Dump",
	[Key.dumpSubtitle]: "Public memory leaks",
	[Key.identity]: "Identity",
	[Key.identitySubtitle]: "Who I am",
	[Key.search]: "Search",
	...
	[Key.projectsTechStack]: "Tech Stack Netstat",
	...
	// Skills Page (legacy - for backward compatibility)
	[Key.skills]: "Skills",
	...
	[Key.personalLog]: "Personal Log",
	[Key.personalLogSubtitle]: "Private area",
	[Key.personalLogCount]: "log entries",
	[Key.personalLogImage]: "Image",
	[Key.personalLogReply]: "Reply",
	[Key.personalLogTips]: "Only the last 30 days are displayed.",
	[Key.personalLogMinutesAgo]: "minutes ago",
	[Key.personalLogHoursAgo]: "hours ago",
	[Key.personalLogDaysAgo]: "days ago",

	[Key.media]: "Media",
	[Key.mediaSubtitle]: "Private media",
	[Key.mediaEmpty]: "It's still empty.",
	[Key.mediaEmptyDesc]: "No albums have been created yet.",
	[Key.mediaBackToList]: "Back to Media",
	[Key.mediaPhotoCount]: "photo",
	[Key.mediaPhotosCount]: "photos",
