...
export const en: Translation = {
	...
	[Key.vaultClearFilters]: "Clear filters",
	[Key.vaultNoResults]: "No posts match this filter",
	[Key.vaultShowAll]: "Show all",
	[Key.vaultExpandAll]: "Expand all",
	[Key.vaultCollapseAll]: "Collapse all",
	[Key.vaultSearchPlaceholder]: "Search posts...",
	[Key.vaultSortBy]: "Sort by",
	[Key.vaultSortDateNewest]: "Date (newest)",
	[Key.vaultSortDateOldest]: "Date (oldest)",
	[Key.vaultSortTitleA]: "Title (A–Z)",
	[Key.vaultSortTitleZ]: "Title (Z–A)",
	[Key.vaultFilters]: "Filters",
	[Key.vaultYear]: "Year",
	[Key.vaultAllYears]: "All years",
	[Key.vaultRemoveFilter]: "Remove filter",
	[Key.dump]: "Dump",
