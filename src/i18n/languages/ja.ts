...
export const ja: Translation = {
	...
	// ナビゲーション
	[Key.main]: "メイン",
	[Key.mainSubtitle]: "CybAlp - サイバーセキュリティ | Linux愛好家 | コーダー",
	[Key.vault]: "金庫",
	[Key.vaultSubtitle]: "機密データ",
	[Key.vaultClearFilters]: "フィルターをクリア",
	[Key.vaultNoResults]: "該当する投稿がありません",
	[Key.vaultShowAll]: "すべて表示",
	[Key.vaultExpandAll]: "すべて展開",
	[Key.vaultCollapseAll]: "すべて折りたたむ",
	[Key.vaultSearchPlaceholder]: "投稿を検索...",
	[Key.vaultSortBy]: "並び替え",
	[Key.vaultSortDateNewest]: "日付（新しい順）",
	[Key.vaultSortDateOldest]: "日付（古い順）",
	[Key.vaultSortTitleA]: "タイトル（A–Z）",
	[Key.vaultSortTitleZ]: "タイトル（Z–A）",
	[Key.vaultFilters]: "フィルター",
	[Key.vaultYear]: "年",
	[Key.vaultAllYears]: "すべての年",
	[Key.vaultRemoveFilter]: "フィルターを削除",
	[Key.dump]: "ダンプ",
	[Key.dumpSubtitle]: "公開メモリリーク",
	[Key.identity]: "アイデンティティ",
	[Key.identitySubtitle]: "私とは",
	[Key.search]: "検索",

	// 投稿
	[Key.tags]: "Alias",
	[Key.categories]: "Directories",
	[Key.series]: "シリーズ",
	[Key.posts]: "投稿",
	[Key.recentPosts]: "最近の投稿",
	[Key.postList]: "投稿リスト",
	[Key.statistics]: "Netstat",
	...
	[Key.backToMain]: "メインに戻る",

	// AR-GEページ
	[Key.arge]: "AR-GE",
	[Key.argeSubtitle]: "Projects and experimental studies",
	// プロジェクトページ
	[Key.projects]: "プロジェクト",
	...
	[Key.toolchainsSubtitle]: "Dependencies",
	// スキルページ (legacy - for backward compatibility)
	[Key.skills]: "スキル",
	...
	[Key.timelineStatistics]: "Netstat",
	...
	// 個人ログページ
	[Key.personalLog]: "個人ログ",
	[Key.personalLogSubtitle]: "プライベートエリア",
	[Key.personalLogCount]: "ログエントリ",
	[Key.personalLogImage]: "画像",
	[Key.personalLogReply]: "返信",
	[Key.personalLogTips]: "最新の30件のログエントリのみを表示",
	[Key.personalLogMinutesAgo]: "分前",
	[Key.personalLogHoursAgo]: "時間前",
	[Key.personalLogDaysAgo]: "日前",

	// アルバムページ
	[Key.media]: "Media",
	[Key.mediaSubtitle]: "生活の美しい瞬間を記録する",
	[Key.mediaEmpty]: "コンテンツなし",
	[Key.mediaEmptyDesc]:
		"アルバムがまだ作成されていません。美しい思い出を追加してください！",
	[Key.mediaBackToList]: "Mediaに戻る",
	[Key.mediaPhotoCount]: "写真",
	[Key.mediaPhotosCount]: "写真",
