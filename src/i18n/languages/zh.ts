...
export const zh: Translation = {
	...
	// 导航
	[Key.main]: "主页",
	[Key.mainSubtitle]: "CybAlp - 网络安全 | Linux爱好者 | 程序员",
	[Key.vault]: "安全",
	[Key.vaultSubtitle]: "机密数据",
	[Key.vaultClearFilters]: "清除筛选",
	[Key.vaultNoResults]: "没有匹配的帖子",
	[Key.vaultShowAll]: "显示全部",
	[Key.vaultExpandAll]: "全部展开",
	[Key.vaultCollapseAll]: "全部折叠",
	[Key.vaultSearchPlaceholder]: "搜索帖子...",
	[Key.vaultSortBy]: "排序",
	[Key.vaultSortDateNewest]: "日期（最新）",
	[Key.vaultSortDateOldest]: "日期（最旧）",
	[Key.vaultSortTitleA]: "标题（A–Z）",
	[Key.vaultSortTitleZ]: "标题（Z–A）",
	[Key.vaultFilters]: "筛选",
	[Key.vaultYear]: "年份",
	[Key.vaultAllYears]: "全部年份",
	[Key.vaultRemoveFilter]: "移除筛选",
	[Key.dump]: "转储",
	[Key.dumpSubtitle]: "公共内存泄漏",
	[Key.identity]: "身份",
	[Key.identitySubtitle]: "我是谁",
	[Key.search]: "搜索",
	...
	// 技能展示页面 (legacy - for backward compatibility)
	[Key.skills]: "技能展示",
	...
	// 个人日志页面
	[Key.personalLog]: "个人日志",
	[Key.personalLogSubtitle]: "私人区域",
	[Key.personalLogCount]: "条日志",
	[Key.personalLogImage]: "图片",
	[Key.personalLogReply]: "回复",
	[Key.personalLogTips]: "只展示最近30条日志",
	[Key.personalLogMinutesAgo]: "分钟前",
	[Key.personalLogHoursAgo]: "小时前",
	[Key.personalLogDaysAgo]: "天前",

	// 相册页面
	[Key.media]: "Media",
	[Key.mediaSubtitle]: "记录生活中的美好瞬间",
	[Key.mediaEmpty]: "暂无内容",
	[Key.mediaEmptyDesc]: "还没有创建任何相册，快去添加一些美好的回忆吧！",
	[Key.mediaBackToList]: "返回Media",
	[Key.mediaPhotoCount]: "张照片",
	[Key.mediaPhotosCount]: "张照片",
