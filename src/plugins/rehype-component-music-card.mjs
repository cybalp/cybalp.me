...
export function MusicCardComponent(properties, children) {
	...
	const title =
		properties.title || (properties.meting ? "Loading..." : "Unknown Title");
	const artist =
		properties.artist || (properties.meting ? "Loading..." : "Unknown Artist");
	...
	const nLyric = h(
		...
		[
			...
			h(
				"div",
				{ class: "lyric-current", style: "grid-area: 1/1;" },
				"Loading lyrics...",
			),
		],
	);
	...
	const nPlayBtn = h(
		"button",
		{ class: "play-btn", id: `${cardUuid}-play`, "aria-label": "Play/Pause" },
		[
	...
	const nProgressBar = h("div", {
		class: "progress-bar",
		id: `${cardUuid}-progress-bar`,
	});
	const nProgressContainer = h(
		"div",
		{ class: "progress-container", id: `${cardUuid}-progress-container` },
		[nProgressBar],
	);

	const nTimeDisplay = h(
		"div",
		{ class: "time-display", id: `${cardUuid}-time` },
		"0:00 / 0:00",
	);
