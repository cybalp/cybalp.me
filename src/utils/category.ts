// ❯ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// ❯ @status OK!
// ❯ @path ./src/utils/category.ts
// ❯ @desc Category path parsing and processing utilities.
// ❯ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
// ❯ PATH PARSING
// ❯ @doc Parses category input into path array.
export function getCategoryPathParts(
	...
	if (Array.isArray(category)) {
		const stringItems = category.filter(
...
// ❯ LABEL GENERATION
// ❯ @doc Converts category path to display label.
